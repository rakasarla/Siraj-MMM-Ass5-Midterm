...
# Purpose: Get Medical Diagnosis to check if the lung image has pneumonia
#          Most of this code is from Week 4 assignment
# Input Parameters:
#     Image
# Output:
#     Diagnosis results
...
#     -------          ------------    -------------------------------------------------------------------
#     1.1              29-SEP-2019     Initial Creation
# ```
...
show_predictions(y_img_batch, y_true_batch, y_pred_batch, subplot_params, 
                 plot_params, class_map, testing_dir, image_file_name_sample, 
                 count=count, sample=True)
